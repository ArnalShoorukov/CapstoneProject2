...
public class PrayTimes {
    ...
    private double calcJD(int year, int month, int day) {
        ...
        @SuppressWarnings("deprecation") Date date = new Date(year, month - 1, day);
    ...
    public static void main(String[] args) {
        double latitude = 42.870022;
        double longitude = 74.587883;
        double timezone = 6;
        int MWL = 2;
        ...
        System.out.println(prayerNames.get(0) + "-" +prayerTimes.get(0));

        System.out.println(prayers.getDatePrayerTimes(2015,12, 14, 42.87, 74.58, 6));
